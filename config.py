...
LONG_STABILITY_THRESHOLD = 0.90
LONG_STABILITY_WINDOW = 5
LONG_STABILITY_MIN_COUNT = 5
SHORT_STABILITY_THRESHOLD = 0.30
SHORT_STABILITY_WINDOW = 15
SHORT_STABILITY_MIN_COUNT = 14
SIGNAL_MIN_INTERVAL_MINUTES = 5
