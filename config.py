...
LEGACY_MODEL_UPDATE_MINUTES = int(os.getenv("LEGACY_MODEL_UPDATE_MINUTES", "10080"))
...
ADAPTIVE_RULE_SWITCH_MIN_SAMPLES = 30
ADAPTIVE_RULE_SWITCH_MIN_WIN_RATE = 0.80
ADAPTIVE_RULE_SWITCH_MIN_WILSON_LOWER = 0.68
ADAPTIVE_RULE_SWITCH_ROLLING_WINDOW = 120
ADAPTIVE_RULE_SWITCH_REGIME_ENABLED = True
ADAPTIVE_RULE_SWITCH_REGIME_MIN_SAMPLES = 5
ADAPTIVE_RULE_SWITCH_ALLOW_GLOBAL_FALLBACK = True
ADAPTIVE_RULE_SWITCH_CONTEXT_ENABLED = True
ADAPTIVE_RULE_SWITCH_CONTEXT_MIN_SAMPLES = 4
ADAPTIVE_RULE_SWITCH_CONTEXT_DISABLE_WIN_RATE = 0.55
ADAPTIVE_RULE_SWITCH_MICRO_CONTEXT_ENABLED = True
ADAPTIVE_RULE_SWITCH_MICRO_CONTEXT_MIN_SAMPLES = 3
ADAPTIVE_RULE_SWITCH_MAX_RECENT_LOSS_STREAK = 2
ADAPTIVE_RULE_MINER_ENABLED = True
ADAPTIVE_RULE_MINER_LOOKBACK_SIGNALS = 2000
ADAPTIVE_RULE_MINER_LOOKBACK_DAYS = 30
ADAPTIVE_RULE_MINER_LOOKBACK_DAY_OPTIONS = (7, 14, 30, 60)
ADAPTIVE_RULE_MINER_MAX_CLAUSES = 3
ADAPTIVE_RULE_MINER_MIN_SAMPLES = 30
ADAPTIVE_RULE_MINER_MIN_WIN_RATE = 0.75
ADAPTIVE_RULE_MINER_MIN_WILSON_LOWER = 0.68
ADAPTIVE_RULE_MINER_LONG_MIN_SAMPLES = 50
ADAPTIVE_RULE_MINER_LONG_MIN_WIN_RATE = 0.78
ADAPTIVE_RULE_MINER_LONG_MIN_WILSON_LOWER = 0.70
ADAPTIVE_RULE_MINER_COOLDOWN_RECORDS = 80
