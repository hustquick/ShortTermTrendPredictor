...
def _build_conditions(df: pd.DataFrame) -> list[tuple[str, np.ndarray]]:
    ...
    thresholds = {
        ...
        "mtf_3m_ret_1": [-0.003, -0.001, -0.0005, 0.0, 0.0005, 0.001, 0.003],
        "mtf_3m_ret_2": [-0.004, -0.002, -0.001, 0.0, 0.001, 0.002, 0.004],
        "mtf_3m_ret_3": [-0.006, -0.003, -0.001, 0.0, 0.001, 0.003, 0.006],
        "mtf_3m_ema_5_20_diff": [-0.002, -0.001, -0.0005, 0.0, 0.0005, 0.001, 0.002],
        "mtf_3m_ema_10_30_diff": [-0.002, -0.001, -0.0005, 0.0, 0.0005, 0.001, 0.002],
        "mtf_3m_macd_hist": [-20, -10, -5, 0, 5, 10, 20],
        "mtf_3m_rsi_14": [25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75],
        "mtf_3m_trend_agreement": [-1.0, -0.333333, 0.0, 0.333333, 1.0],
        "mtf_3m_taker_buy_ratio": [0.30, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70],
        "mtf_3m_volume_ratio_5": [0.80, 1.00, 1.20, 1.50, 2.00],
        "mtf_5m_ret_1": [-0.004, -0.002, -0.001, 0.0, 0.001, 0.002, 0.004],
        "mtf_5m_ret_2": [-0.006, -0.003, -0.001, 0.0, 0.001, 0.003, 0.006],
        "mtf_5m_ret_3": [-0.008, -0.004, -0.002, 0.0, 0.002, 0.004, 0.008],
        "mtf_5m_ema_5_20_diff": [-0.002, -0.001, -0.0005, 0.0, 0.0005, 0.001, 0.002],
        "mtf_5m_ema_10_30_diff": [-0.002, -0.001, -0.0005, 0.0, 0.0005, 0.001, 0.002],
        "mtf_5m_macd_hist": [-20, -10, -5, 0, 5, 10, 20],
        "mtf_5m_rsi_14": [25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75],
        "mtf_5m_trend_agreement": [-1.0, -0.333333, 0.0, 0.333333, 1.0],
        "mtf_5m_taker_buy_ratio": [0.30, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70],
        "mtf_5m_volume_ratio_5": [0.80, 1.00, 1.20, 1.50, 2.00],
    }
